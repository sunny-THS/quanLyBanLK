IF EXISTS(SELECT * FROM sys.databases WHERE name='QLBLK')
BEGIN
	DROP DATABASE QLBLK
END
...
AS
	...
	SELECT @maLOAI = MALOAI FROM LOAILK WHERE TENLOAI=@tenLoai
	BEGIN TRY
		INSERT LINHKIEN
		VALUES(DBO.AUTO_IDLK(@maLOAI), @tenLK, @ngSX, @tgbh, @maLOAI, @nsx, @dvt, @sl)
	END TRY
	BEGIN CATCH
		RETURN -1
	END CATCH
...
CREATE FUNCTION AUTO_IDLK(@maLoai VARCHAR(10))
RETURNS VARCHAR(10)
AS
BEGIN
	DECLARE @ID VARCHAR(10)

	IF (SELECT COUNT(MALK) FROM LINHKIEN WHERE MALOAI = @maLoai) = 0
		SET @ID = '0'
	ELSE
		SELECT @ID = MAX(RIGHT(MALK, 3)) FROM LINHKIEN WHERE MALOAI = @maLoai

	SELECT @ID = CASE
		WHEN @ID >=  0 and @ID < 9 THEN @maLoai + '00' + CONVERT(CHAR, CONVERT(INT, @ID) + 1)
		WHEN @ID >=  9 THEN @maLoai + '0' + CONVERT(CHAR, CONVERT(INT, @ID) + 1)
		WHEN @ID >= 99 THEN @maLoai + CONVERT(CHAR, CONVERT(INT, @ID) + 1)
	END
...
AS
RETURN
	SELECT MALK, TENLK, TGBH, NSX, SOLUONGTONKHO, MALOAI
	FROM LINHKIEN
GO
...
BEGIN
	INSERT INTO @list
	SELECT MALK, TENLK, TGBH, NSX, SOLUONGTONKHO
	FROM LINHKIEN
...
BEGIN
	...
	BEGIN
		...
		INSERT INTO @list
		SELECT N'Tháng ' + LTRIM(@Month), @DoanhThu
...
ADD CONSTRAINT CK_TGBH CHECK (TGBH > 0),
		CONSTRAINT CK_SL CHECK (SOLUONGTONKHO >= 0)
...
SET DATEFORMAT DMY
INSERT LINHKIEN VALUES ('SCREEN001', N'Màn hình máy tính ASUS', '20/10/2018', 12, 'SCREEN', 'ASUS', N'Cái', 160)
INSERT LINHKIEN VALUES ('SCREEN002', N'Màn hình máy tính DELL', '12/04/2018', 12, 'SCREEN', 'DELL', N'Cái', 165)
INSERT LINHKIEN VALUES ('MOU001', N'ChUột có dây LOGITECH', '19/06/2019', 6, 'MOU', 'LOGITECH', N'Cái', 164)
INSERT LINHKIEN VALUES ('MOU002', N'ChUột không dây LOGITECH', '19/06/2019', 6, 'MOU', 'LOGITECH', N'Cái', 160)
INSERT LINHKIEN VALUES ('MAI001', N'Mainboard ASUS', '17/5/2020', 12, 'MAI', 'ASUS', N'Cái', 167)
INSERT LINHKIEN VALUES ('MAI002', N'Mainboard ATXX', '16/6/2020', 12, 'MAI', 'ATXX', N'Cái', 162)
INSERT LINHKIEN VALUES ('CPU001', N'CPU Itel', '28/10/2018', 12, 'CPU', 'Intel', N'Cái', 161)
INSERT LINHKIEN VALUES ('KEYB001', N'Bàn phím LOGITECH', '20/10/2018', 6, 'KEYB', 'LOGITECH', N'Cái', 160)
INSERT LINHKIEN VALUES ('HP001', N'Tai nghe SONY', '4/6/2019', 12, 'HP', 'SONY', N'Cái', 160)
INSERT LINHKIEN VALUES ('PROJ001', N'Máy chiếu DELL', '20/10/2018', 12, 'PROJ', 'DELL', N'Cái', 160)
INSERT LINHKIEN VALUES ('PROJ002', N'Máy chiếu HP', '20/10/2018', 12, 'PROJ', 'HP', N'Cái', 160)
INSERT LINHKIEN VALUES ('PCX001', N'ASUS 20144', '20/10/2018', 12, 'PCX', 'ASUS', N'Cái', 165)
...
SET DATEFORMAT DMY
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD001', '3/4/2021', 1, 1)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD002', '13/5/2021', 1, 2)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD003', '23/9/2021', 1, 3)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD004', '13/2/2021', 2, 4)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD005', '22/7/2021', 3, 5)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD006', '15/10/2021', 4, 6)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD007', '25/10/2021', 4, 7)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD008', '17/12/2021', 5, 8)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD009', '1/1/2021', 5, 9)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD010', '5/3/2021', 5, 9)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD011', '24/3/2021', 2, 10)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD012', '17/3/2021', 2, 10)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD013', '11/6/2021', 3, 8)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD014', '7/8/2021', 4, 7)
INSERT HOADON (MAHD, NGAYHD, MAKH, MANV) VALUES ('HD015', '5/11/2021', 4, 5)

SET DATEFORMAT DMY
INSERT DONGIA VALUES ('SCREEN001', '1/1/2020', 3690000)
INSERT DONGIA VALUES ('SCREEN002', '1/1/2020', 2500000)
INSERT DONGIA VALUES ('MOU001', '1/1/2020', 92000)
INSERT DONGIA VALUES ('MOU002', '1/1/2020', 279000)
INSERT DONGIA VALUES ('MAI001', '1/1/2020', 2790000)
INSERT DONGIA VALUES ('MAI002', '1/1/2020', 2500000)
INSERT DONGIA VALUES ('CPU001', '1/1/2020', 5099000)
INSERT DONGIA VALUES ('KEYB001', '1/1/2020', 160000)
INSERT DONGIA VALUES ('HP001', '1/1/2020', 950000)
INSERT DONGIA VALUES ('PROJ001', '1/1/2020', 11220000)
INSERT DONGIA VALUES ('PROJ002', '1/1/2020', 10200000)
INSERT DONGIA VALUES ('PCX001', '1/1/2020', 16749000)

INSERT CHITIETHD VALUES ('HD001', 'SCREEN001', 2, 12000000)
INSERT CHITIETHD VALUES ('HD001', 'CPU001', 6, 12000000)
INSERT CHITIETHD VALUES ('HD002', 'MOU002', 3, 560000)
INSERT CHITIETHD VALUES ('HD002', 'PROJ001', 6, 560000)
INSERT CHITIETHD VALUES ('HD003', 'MAI002', 5, 22000000)
INSERT CHITIETHD VALUES ('HD004', 'CPU001', 10, 27000000)
INSERT CHITIETHD VALUES ('HD005', 'HP001', 8, 5000000)
INSERT CHITIETHD VALUES ('HD005', 'PCX001', 3, 5000000)
INSERT CHITIETHD VALUES ('HD006', 'HP001', 6, 7500000)
INSERT CHITIETHD VALUES ('HD007', 'PCX001', 2, 340000000)
INSERT CHITIETHD VALUES ('HD008', 'PROJ002', 9, 15000000)
INSERT CHITIETHD VALUES ('HD009', 'PCX001', 2, 15000000)
INSERT CHITIETHD VALUES ('HD010', 'KEYB001', 9, 15000000)
INSERT CHITIETHD VALUES ('HD011', 'PROJ002', 5, 15000000)
INSERT CHITIETHD VALUES ('HD012', 'CPU001', 4, 15000000)
INSERT CHITIETHD VALUES ('HD013', 'MAI002', 8, 15000000)
INSERT CHITIETHD VALUES ('HD014', 'MOU002', 7, 15000000)
INSERT CHITIETHD VALUES ('HD014', 'KEYB001', 9, 15000000)
INSERT CHITIETHD VALUES ('HD014', 'MAI002', 4, 15000000)
INSERT CHITIETHD VALUES ('HD015', 'SCREEN002', 6, 15000000)
